...
void Main()
{
	string path = @"D:\projs\st\OopLinq\data\results_2010.json";
...
static List<FootballGame> ReadFromFileJson(string path)
{
    ...
    var games = JsonSerializer.Deserialize<List<FootballGame>>(jsondata, options);

    return games ?? new List<FootballGame>(); 
}
